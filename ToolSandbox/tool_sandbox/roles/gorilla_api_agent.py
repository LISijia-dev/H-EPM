...
def get_prompt(user_query: str, functions: list[ChatCompletionToolParam]) -> str:
    ...
    system = (
        ...
        " IMPORTANT: You MUST call the function 'summarize_the_task' at least once during the conversation to help you make decisions about actions. This is a required step in your workflow."
        " When you need to summarize the current task state to aid decision-making or before planning,"
        " call the function 'summarize_the_task' with a concise 'summary' string that captures the"
        " environment, user info, current progress, and next steps. At leaset call this function once in the conversition."
    )
    if len(functions) == 0:
